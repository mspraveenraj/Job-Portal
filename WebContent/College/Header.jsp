       ...
       <table width="100%" cellspacing="0" cellpadding="0" align="center">
            	<tr valign="top">
                	<td colspan="2"  height="45" >
                            <pre><a href="Home.jsp" >Home Page</a>  <a href="RegCompany.jsp" >Registered Companies</a>    <a href="Profile.jsp" >College Profile</a>       <a href="Account.jsp" >Account Setting</a>       <a href="../Logout" >Logout</a>  </pre></td>
                </tr>
        </table>
        </div>
       <%
