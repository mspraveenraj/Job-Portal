       ...
       <table width="100%" cellspacing="0" cellpadding="0" align="center">
            	<tr valign="top">
                	<td colspan="2"  height="45" >
                            <pre><a href="Home.jsp" >Home Page</a>   <a href="RegCollege.jsp" >Registered Colleges</a> <a href="Profile.jsp" >Company Profile</a>    <a href="Account.jsp" >Company Account</a>    <a href="JobPosting.jsp" >Job Posting</a> <a href="StudentSearch.jsp" >Student Search</a> <a href="../Logout" >Logout</a></pre></td>
                </tr>
        </table>
        </div>
         <%
