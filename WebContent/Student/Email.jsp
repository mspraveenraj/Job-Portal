...
<html>
    ...
    <table width="868" height="540" border="0" cellpadding="2" cellspacing="0" align="center">
      <tr>
        ...
        <td width="709"><input name="to" type="text" size="100"></td>
      </tr>
      <tr>
        <th height="38" scope="row"><h3>Cc:</h3></th>
        <td><input name="cc" type="text" size="100"></td>
      </tr>
      <tr>
        <th height="38" scope="row"> <h3>BCc:</h3></th>
        <td><input name="bcc" type="text" size="100"></td>
      </tr>
      <tr>
        <th height="38" scope="row"><h3>Subject:</h3></th>
        <td><input name="sub" type="text" size="100"></td>
      </tr>
      <tr>
       ...
       <tr>
        <th height="199" colspan="2" scope="row"><textarea name="message" cols="100" rows="10" class="txtar"></textarea></th>
       </tr>
<tr>
